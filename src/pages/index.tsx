  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Discover B2C Car sharing v1 - Where individual customers meet their mobility needs, booking available cars nearby, all managed from centralized dashboards by dedicated operations staff."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Discover B2C Car sharing v1 - Where individual customers meet their mobility needs, booking available cars nearby, all managed from centralized dashboards by dedicated operations staff.`}
            </Text>
            <Box
